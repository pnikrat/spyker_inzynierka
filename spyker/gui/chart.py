...
from spyker.plots import MFCC, Raw, FFT, STFT, STFT3D
...
class CanvasWindow(QtGui.QWidget):
    def __init__(self, recname, plotnumber):
        ...
        self.plotobj = [Raw, MFCC, FFT, STFT, STFT3D]

        self.plotnames = [ChartType.RAW, ChartType.MFCC, ChartType.FFT, ChartType.STFT, ChartType.STFT3D]
